...
<div style="background-color: rgba(255, 165, 0, 0.6); border-radius: 10px" class="container mt-4 mb-4 text-center">
    <div style="background-color: rgba(39, 71, 245, 0.8); border-radius: 10px; color: white; align-content:center" class="container mb-5 text-center"><h3>Update Project</h3></div>
    <form:form action="/saveUpdateProject" method="post" modelAttribute="project">
        <form:hidden path="id" />
        <div class="form-row">
            <div class="form-group col-md-6">
                <label for="username"><strong>Project Name</strong></label>
                <form:input type="text" path="username" class="form-control" id="username" placeholder="Project title" />
            </div>
            <div class="form-group col-md-4">
                <label for="inputState"><strong>Status</strong></label>
                <form:select path="completeStatus" id="inputState" class="form-control">
        ...
        <div class="form-group">
            ...
            <form:input path="projectDescription" type="text" class="form-control" id="description" name="description" placeholder="Description of Project" />
        </div>
