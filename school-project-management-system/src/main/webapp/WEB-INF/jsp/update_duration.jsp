...
<div style="background-color: rgba(255, 165, 0, 0.6); border-radius: 10px" class="container mt-4 mb-4 text-center align-items-center">
    ...
    <form:form action="/saveUpdateDuration" method="post" modelAttribute="duration">
        <form:input hidden="true" path="id" value="${duration.id}"/>
        <form:input hidden="true" path="projectId" value="${duration.projectId}"/>
        <div class="form-group d-flex justify-content-center">
            <div class="form-group col-md-6">
                <label for="durationDescription"><strong>Description</strong></label>
                <form:input type="text" path="durationDescription" class="form-control text-center" id="durationDescription" placeholder="Descripiton" />
            </div>
